...
public class ManualRide_Otp_activity_ViewBinding implements Unbinder {
  private ManualRide_Otp_activity target;

  private View view7f0900dc;

  @UiThread
  public ManualRide_Otp_activity_ViewBinding(ManualRide_Otp_activity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ManualRide_Otp_activity_ViewBinding(final ManualRide_Otp_activity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ManualRide_Otp_activity target = this.target;
