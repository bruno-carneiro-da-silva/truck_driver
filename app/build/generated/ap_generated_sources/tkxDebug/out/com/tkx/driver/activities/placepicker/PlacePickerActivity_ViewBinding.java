...
public class PlacePickerActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public PlacePickerActivity_ViewBinding(PlacePickerActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PlacePickerActivity_ViewBinding(PlacePickerActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PlacePickerActivity target = this.target;
