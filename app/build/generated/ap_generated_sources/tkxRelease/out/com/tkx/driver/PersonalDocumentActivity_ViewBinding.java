...
public class PersonalDocumentActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public PersonalDocumentActivity_ViewBinding(PersonalDocumentActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PersonalDocumentActivity_ViewBinding(PersonalDocumentActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PersonalDocumentActivity target = this.target;
